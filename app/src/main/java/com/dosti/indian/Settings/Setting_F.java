package com.dosti.indian.Settings;
...
import com.dosti.indian.Accounts.Request_Varification_F;
...
import com.dosti.indian.SimpleClasses.Webview_F;
...
public class Setting_F extends RootFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view.findViewById(R.id.report_txt).setOnClickListener(this);
        view.findViewById(R.id.logout_txt).setOnClickListener(this);
        view.findViewById(R.id.terms_txt).setOnClickListener(this);
    ...
    public void Open_Terms_url(){
        ...
        transaction.setCustomAnimations(R.anim.in_from_right, R.anim.out_to_left, R.anim.in_from_left, R.anim.out_to_right);
        Bundle bundle=new Bundle();
        bundle.putString("url",Variables.terms_and_conditions);
    ...
    //report own code
    public void Open_Report_url(){
        Webview_F webview_f = new Webview_F();
        FragmentTransaction transaction = getActivity().getSupportFragmentManager().beginTransaction();
        transaction.setCustomAnimations(R.anim.in_from_right, R.anim.out_to_left, R.anim.in_from_left, R.anim.out_to_right);
        Bundle bundle=new Bundle();
        bundle.putString("url",Variables.report_video);
