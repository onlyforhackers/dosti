...
public class Variables {
    ...
    public static final String app_folder=root+"/Dosti/";
    ...
    public static String tag="Dosti_";
    ...
    public static String gif_api_key1="rQCbLssKZOGIsYyO1LbElq4Ee2tDIlTP";
    public static final String privacy_policy="https://indiandosti.xyz/privacy-policy/";
    public  static final String report_video="https://indiandosti.xyz/suggestions-report-form/";
    public  static final String terms_and_conditions="https://indiandosti.xyz/terms-conditions/";
     

     public static String base_url="http://indiandosti.xyz/v/";
